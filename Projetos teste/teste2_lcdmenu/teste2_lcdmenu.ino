...
if(ButtonEnter == 0 && StateEnterControl == 1) // Verifica se o botão Enter está pressionado
{
  if(count == 1) // Verifica o valor da variável contagem
  {
    StateLed1 = !StateLed1; // Inverte o valor da variável
...
if(ButtonEnter== 0 && StateEnterControl == 0)
{
  StateEnterControl = 1;
  lcd.clear();
